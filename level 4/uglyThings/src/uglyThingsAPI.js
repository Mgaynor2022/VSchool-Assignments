...
const UglyThings = createContext(null)
 ...
 function UglyThingsContext(props){
    ...
    useEffect(() => {
         ...
         axios.get("https://api.vschool.io/michael_gaynor/thing")
    ...
    function handleSubmit(event){
        ...
        const addItem = {
            ...
            axios.post("https://api.vschool.io/michael_gaynor/thing", addItem)
            .then((res) => setUglyThingsArray(prevArray => [...prevArray, res.data]))
            .catch(error => console.log(error. response. data))
    }

    function handleDelete(id){
        axios.delete(`https://api.vschool.io/michael_gaynor/thing/${id}`)
        .then(() => {
     ...
     async function handleEdit(updatedItem, id) {
        ...
        await axios.put(`https://api.vschool.io/michael_gaynor/thing/${id}`, editItem)
